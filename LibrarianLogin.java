...
public class LibrarianLogin extends JFrame {
	...
	private Image img_logo = new ImageIcon(LibrarianLogin.class.getResource("res/library.png")).getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH);
	...
	public LibrarianLogin() {
		...
		panel_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {	
				if(txtUser.getText().equalsIgnoreCase("Librarian_01") && txtPass.getText().equals("LibOne") ||
				   txtUser.getText().equalsIgnoreCase("Librarian_02") && txtPass.getText().equals("LibTwo") ||
				   txtUser.getText().equalsIgnoreCase("Librarian_03") && txtPass.getText().equals("LibThree")) {
					lblLoginMsg.setText("");
